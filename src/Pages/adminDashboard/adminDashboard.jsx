...
.profile-header h3 { font-size: 16px; font-weight: 700; }
...
.profile-body .row:last-child { border-bottom: none; }
...
.chip {
  background: rgba(90,255,212,0.1);
  color: var(--accent);
  padding: 3px 8px;
  border-radius: 999px;
  font-size: 11px;
...
.profile-search:focus {
  border-color: rgba(90,255,212,0.4);
  box-shadow: 0 0 0 2px rgba(90,255,212,0.1);
}
